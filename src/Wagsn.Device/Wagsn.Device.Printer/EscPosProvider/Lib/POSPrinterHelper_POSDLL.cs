...
namespace Wagsn.Device.Printer.EpsPosProvider
{
    ...
    /// 封装 POSDLL.dll 函数库
    /// </summary>
    public class POSPrinterHelper_POSDLL
    {
        ...
        public uint Form_Line_x = 80;
        public uint Form_Line_y = 110;
        public uint Form_Line_y_interval = 50;
        public uint Form_Vertical_x = 69;
        public uint Form_Vertical_y_interval = 50;
        public uint Form_Vertical_y = 134;
        public uint Form_Vertical_y_2 = 158;
        public uint Form_TitleSize_x = 1;
        public uint Form_TitleSize_y = 2;
        public uint Form_Title_x = 900;
        public uint Form_Title_y = 45;
        public uint Form_TextSize_x = 1;
        public uint Form_TextSize_y = 1;
        public uint Form_TextLine_x = 120;
        public uint Form_TextLine_x2 = 1550;
        public uint Form_TextLine_y = 90;
        public uint Form_TextLine_y_interval = 50;
        public uint PrintBmpInRAM_x = 1580;
        public uint PrintBmpInRAM_y = 510;
        public string CunGen = "(存根)";
        public string PingZheng = "(凭证)";
        public string YuanQu = "(园区)";
        public string Form_Line = "________________________________________________________________________________________";
        //string Form_Line2 = "__________________________________________________________________";
        public string Form_Vertical = "|             |                                          |            |                 |";
        public string Form_Vertical2 = "|             |                                                                         |";
        ...
        /// POS页模式
        /// </summary>
        public uint POS_BITMAP_PRINT_NORMAL = 0x00;   //  正常
        ...
        /// <summary>标准模式（行模式）</summary>
        public uint POS_PRINT_MODE_STANDARD = 0x00;
        /// <summary>页模式</summary>
        public const uint POS_PRINT_MODE_PAGE = 0x01;
        /// <summary>黑标记标签模式</summary>
        public uint POS_PRINT_MODE_BLACK_MARK_LABEL = 0x02;
        /// <summary>白标记标签模式</summary>
        public uint POS_PRINT_MODE_WHITE_MARK_LABEL = 0x03;
        /// <summary>
        ...
        /// <summary>左上角：纵向打印</summary>
        public const uint POS_AREA_LEFT_TO_RIGHT = 0x00;
        /// <summary>左下角：横向打印</summary>
        public const uint POS_AREA_BOTTOM_TO_TOP = 0x01;
        /// <summary>右下角：纵向打印</summary>
        public const uint POS_AREA_RIGHT_TO_LEFT = 0x02;
        /// <summary>右上角：横向打印</summary>
        public const uint POS_AREA_TOP_TO_BOTTOM = 0x03;
        /// <summary>
        /// 设置页面的打印区域。
        /// </summary>
        /// <param name="nOrgx">指定区域的 X （水平）方向的起始点和左边界的距离。</param>
        /// <param name="nOrgY">指定区域的 Y （垂直）方向的起始点和上边界（当前打印头位置）的距离点数。</param>
        /// <param name="nWidth">指定打印区域的宽度（水平方向）。</param>
        /// <param name="nheight">指定打印区域的高度（垂直方向）。</param>
        /// <param name="nDirection">指定打印区域的方向（原点位置）。
        /// POS_AREA_LEFT_TO_RIGHT  0 左上角 
        /// POS_AREA_BOTTOM_TO_TOP 1 左下角
        /// POS_AREA_RIGHT_TO_LEFT 2 右下角
        /// POS_AREA_TOP_TO_BOTTOM 3 右上角</param>
        /// <returns></returns>
        [DllImport("POSDLL.dll", SetLastError = true)]
        ...
        /// </summary>
        /// <param name="pszString">指向以 null 结尾的字符串缓冲区。</param>
        /// <param name="nOrgx">指定 X 方向（水平）的起始点位置离左边界的点数。
        /// 可以为 0 到 65535，如果该参数设置为65535则忽略该设置，函数将不对X 方向（水平）的起始点位置进行设置。</param>
        /// <param name="nOrgY">指定 Y 方向（垂直）的起始点位置离上边界的点数。
        /// 可以为 0 到 65535，如果该参数设置为65535则忽略该设置，函数将不对Y 方向（垂直）的起始点位置进行设置。</param>
        /// <param name="nWidthTimes">指定字符的宽度方向上的放大倍数。
        /// 可以为 1到 6。</param>
        /// <param name="nHeightTimes">指定字符高度方向上的放大倍数。
        /// 可以为 1 到 6。</param>
        /// <param name="nFontType">指定字符的字体类型。
        /// 可以为以下列表中所列值之一。Flag Value Meaning 
        ...
        ///</param>
        /// <param name="nFontStyle">指定字符的字体风格。
        ...
        public byte NETQueryStatus(string ip) 
        {
            byte state;
            var i = POS_NETQueryStatus(ip, out state);
            return state;
        }

        public bool Reset()
        {
            IntPtr tmpIntPtr = POS_Reset();
            if ((int)tmpIntPtr != -1)
                return true;
            else
                return false;
        ...
        public string ChangeTime(string timeStr)
        {
            try
            {
                ...
                string data = DateTime.Parse(timeStr).ToString("yyyy/MM/dd");
                string time = DateTime.Parse(timeStr).ToString("HH:mm:ss");
