...
namespace WS.Iot.Common.PosPrinter
{
    /// <summary>
    /// 封装 POSDLL.dll 接口
    /// </summary>
    public class PosDllWraper
    {
        ...
        /// 函数返回值
        /// </summary>
        public const uint POS_SUCCESS = 1001;//  函数执行成功
        public const uint POS_FAIL = 1002;   //  函数执行失败
        public const uint POS_ERROR_INVALID_HANDLE = 1101; // 端口或文件的句柄无效
        public const uint POS_ERROR_INVALID_PARAMETER = 1102;// 参数无效
        public const uint POS_ERROR_NOT_BITMAP = 1103; // 不是位图格式的文件
        public const uint POS_ERROR_NOT_MONO_BITMAP = 1104;// 位图不是单色的
        public const uint POS_ERROR_BEYONG_AREA = 1105;//位图超出打印机可以处理的大小
        public const uint POS_ERROR_INVALID_PATH = 1106; // 没有找到指定的文件路径或名

        /// <summary>
        /// 停止位
        /// </summary>
        public const uint POS_COM_ONESTOPBIT = 0x00;//停止位为1
        public const uint POS_COM_ONE5STOPBITS = 0x01;//停止位为1.5
        public const uint POS_COM_TWOSTOPBITS = 0x02;//停止位为2

        /// <summary>
        /// 奇偶校验
        /// </summary>
        public const uint POS_COM_NOPARITY = 0x00;//无校验
        public const uint POS_COM_ODDPARITY = 0x01;//奇校验
        public const uint POS_COM_EVENPARITY = 0x02;//偶校验
        public const uint POS_COM_MARKPARITY = 0x03;//标记校验
        public const uint POS_COM_SPACEPARITY = 0x04;//空格校验

        /// <summary>
        /// 其他COM口参数及端口类型定义
        /// </summary>
        public const uint POS_COM_DTR_DSR = 0x00;// 流控制为DTR/DST 
        public const uint POS_COM_RTS_CTS = 0x01;// 流控制为RTS/CTS
        public const uint POS_COM_XON_XOFF = 0x02;// 流控制为XON/OFF
        public const uint POS_COM_NO_HANDSHAKE = 0x03;//无握手
        public const uint POS_OPEN_PARALLEL_PORT = 0x12;//打开并口通讯端口
        public const uint POS_OPEN_BYUSB_PORT = 0x13;//打开USB通讯端口
        public const uint POS_OPEN_PRINTNAME = 0X14;// 打开打印机驱动程序
        public const uint POS_OPEN_NETPORT = 0x15;// 打开网络接口

        /// <summary>
        /// 切纸模式
        /// </summary>
        public const uint POS_CUT_MODE_FULL = 0x00;// 全切
        public const uint POS_CUT_MODE_PARTIAL = 0x01;// 半切
